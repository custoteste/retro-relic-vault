...
const GallerySection = () => {
  ...
  return (
    <section className="py-16 px-4 bg-dark relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-primary/[0.07] to-transparent pointer-events-none" />
      <h2 className="font-display text-[clamp(24px,5vw,38px)] text-dark-foreground text-center mb-2 tracking-wide relative z-10">
        📚 Preservado Como Un Verdadero Archivo Histórico
      </h2>
      <p className="text-muted-foreground text-lg text-center mb-8 relative z-10">
        Cada edición fue cuidadosamente digitalizada para mantener colores, trazos y detalles originales.
      </p>
